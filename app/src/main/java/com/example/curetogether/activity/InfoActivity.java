        ...
        FirebaseDatabase.getInstance().getReference()
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                        ...
                        ArrayAdapter<String> spinnerAdapter = new ArrayAdapter<>(InfoActivity.this, android.R.layout.simple_spinner_item, diseases);
                    ...
                    public void onCancelled(@NonNull @NotNull DatabaseError error) {
                        dialog.stop();
                        Toast.makeText(InfoActivity.this, "Problem fetching disease list", Toast.LENGTH_LONG).show();
                    }
                });
    }
